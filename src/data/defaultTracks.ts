...
export const INITIAL_TRACKS: Track[] = [
  ...
  {
    id: 'track-gbeku',
    title: 'Gbeku | Legit9ja.com',
    artist: 'Zlatan ft. Burna Boy',
    album: 'Zanku Vibes',
    duration: 210,
  ...
  {
    id: 'track-ikperem-nala',
    title: 'Ikperem Nala || busysinging.com',
    artist: 'Chaisong',
    album: 'Gospel Praise & Worship',
    duration: 280,
    url: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3',
